...
opt.cosmomvpa.pathOutput = fullfile(opt.dir.derivatives, 'cosmo-mvpa', opt.dir.statsTask,opt.cosmomvpa.ROIlabel,'crossmodal');
...
cosmomvpaRoiCrossValidation_ReadSpeech_crossmodal_pairwise(opt) % ADJUSTED?
disp('Crossmodal MVPA done!')
