...
function cosmomvpaRoiCrossValidation_ReadSpeech_crossmodal_pairwise(opt)
...
%                                           '.nii']);
        ...
        for iRoiDimension = 1:length(opt.cosmomvpa.roiDimension)
            ...
            for iMask = 1:length(roiMasks)
                ...
                %% 2 spatial frequencies by 2 modalities + full motion by 2 modalities
                stim = [1 2 3  ...
                        1 2 3];
                
                

                % labels = {'visual_sf_high', 'visual_sf_low', 'visual_full_motion', ...
                %           'auditory_sf_high', 'auditory_sf_low', 'auditory_full_motion', ...
                %           'tactile_sf_high', 'tactile_sf_low', 'tactile_full_motion'};
                
                modalityNb = [1 1 1 ...
                              2 2 2];
            
%                 modalityName = {'visual', 'visual', 'visual' ...
%                                 'auditory', 'auditory', 'auditory', ...
%                                 'tactile', 'tactile', 'tactile'};

%                 conditionsToTest = {'trainVis_testAud', ...  % 1 vs 2
%                                     'trainVis_testTact', ... % 1 vs 3
%                                     'trainAud_testVis', ...  % 2 vs 1
%                                     'trainAud_testTact', ... % 2 vs 3
%                                     'trainTact_testVis', ... % 3 vs 1 
%                                     'trainTact_testAud'};    % 3 vs 2
...
function  accu = storeResults(accu, count, subID, roiName, ...
    roiDimension, mask_size, ffxResult, conditionName, accuracy, pred)
